...
const ResultBlock = ({ answers, answeredA, answeredB, answeredC, answeredD, correctAnswer, question, pin, nextStep, fetchScoreboard }) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Button variant="contained" color="primary" onClick={handleClick} className={styles.nextBtn}>
            Next
          </Button>
        </Grid>
        <Grid
