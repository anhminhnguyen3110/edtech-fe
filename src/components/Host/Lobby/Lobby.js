...
import theme from '../Music/theme2.mp3';
  ...
  render() {
    ...
    return (
      <div className={ styles.main }>
        ...
        <div>
          <audio ref="audio_tag" src={ theme } autoPlay muted={ this.state.muted } loop/>
        </div>
        <Grid
          container
          direction="column"
        >
          ...
          >
            <div className={ styles.title }>
              <div className={ styles.join }><span>Join with Game PIN: </span></div>
